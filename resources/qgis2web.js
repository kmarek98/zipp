...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-16023868.058799, 577817.878040, -5135517.123575, 6482496.909642], maxZoom: 6, minZoom: 3
    })
});


    var searchLayer = new SearchLayer({
      layer: lyr_destmsol_5,
      colName: 'Name',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-16023868.058799, 577817.878040, -5135517.123575, 6482496.909642], map.getSize());
